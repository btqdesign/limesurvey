...
class __TwigTemplate_e789e6b465dec348a542094153d10463828eef49e0f41c5c2ac53a28ba9aa495 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array();
        $functions = array("imageSrc" => 22, "darkencss" => 171, "lightencss" => 174, "registerScriptFile" => 244, "assetPublish" => 244, "registerScript" => 245);

        try {
            $this->env->getExtension('Twig_Extension_Sandbox')->checkSecurity(
                array('if', 'set'),
                array(),
                array('imageSrc', 'darkencss', 'lightencss', 'registerScriptFile', 'assetPublish', 'registerScript')
            );
...
";
        ...
        if (($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "options", array()), "stickymatrixheaders", array()) == "on")) {
            // line 244
            echo "    ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(LS_Twig_Extension::registerScriptFile(LS_Twig_Extension::assetPublish(($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "oTemplate", array()), "path", array()) . "scripts/sticky.min.js")), "POS_BEGIN"));
            echo "
    ";
            // line 245
