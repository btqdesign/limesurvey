...
class __TwigTemplate_e09109848f593ca191e111f1202a9bc308435dccf377ee960f898b4b21f95aeb extends Twig_Template
{
...
{% if aSurveyInfo.alanguageChanger.show == true %}
    ...
    <div class=\" {{ aSurveyInfo.class.formgroup }} form-change-lang form-inline\" {{ aSurveyInfo.attr.formgroup }} >
        ...
        {% set buttonhtmlOptions = {
                ...
                'value'         : 'changelang',
                'name'          : 'move',
                'class'         : 'btn btn-info ls-js-hidden ls-language-changer-item ',
            }
        %}
        {{
            C.Html.htmlButton(
...
{% endif %}
", "./subviews/navigation/language_changer.twig", "/var/www/limesurvey/themes/survey/vanilla/views/subviews/navigation/language_changer.twig");
    }
}
