...
class __TwigTemplate_7e40ff0517fb3e82ac28427d98e422e314ad8aa1124173c42862588ae86cddb2 extends Twig_Template
{
...
";
    ...
    <li class=\"";
        ...
        <a class=\"";
            ...
            // line 36
            echo "            ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(eT("Language:"));
            echo " ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(eT($this->getAttribute($this->getAttribute(($context["aLCD"] ?? null), "aListLang", array()), $this->getAttribute(($context["aLCD"] ?? null), "sSelected", array()), array(), "array")));
            echo "
            <span class=\"";
            // line 37
        ...
        <ul class=\"";
            ...
            foreach ($context['_seq'] as $context["value"] => $context["lang"]) {
                ...
                echo ">
                        ";
                // line 45
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(eT($context["lang"]));
                echo "
                    </a>
                </li>
            ";
    ...
    ";
            // line 57
            echo "    ";
            $context["aButtonhtmlOptions"] = array("id" => "changlangButton", "type" => "submit", "value" => "changelang", "name" => "move", "class" => "btn btn-default ls-js-hidden");
            // line 65
            echo "
    ";
            // line 66
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->getAttribute($this->getAttribute(            // line 67
($context["C"] ?? null), "Html", array()), "htmlButton", array(0 => gT("Change the language"), 1 =>             // line 69
($context["aButtonhtmlOptions"] ?? null)), "method"));
            // line 71
            echo "
...
<script>
    ...
    \$(document).ready(function(){
        template.initTopMenuLanguageChanger('.";
        // line 78
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "class", array()), "lctdropdownlia", array()));
        echo "', 'form#limesurvey');
    });
</script>
";
    }
    ...
    {
        return array (  150 => 78,  144 => 74,  139 => 71,  137 => 69,  136 => 67,  135 => 66,  132 => 65,  129 => 57,  124 => 49,  114 => 45,  106 => 44,  99 => 43,  94 => 42,  86 => 40,  78 => 37,  71 => 36,  64 => 33,  58 => 32,  54 => 30,  51 => 29,  48 => 27,  46 => 26,  43 => 24,);
    }
    ...
    {
        return new Twig_Source("", "./subviews/navigation/language_changer_top_menu.twig", "/var/www/limesurvey/templates/default/views/subviews/navigation/language_changer_top_menu.twig");
    }
}
