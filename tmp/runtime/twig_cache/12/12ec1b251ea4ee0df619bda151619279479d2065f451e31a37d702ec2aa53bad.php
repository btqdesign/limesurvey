...
class __TwigTemplate_c1a6b5f4cef9aea12c03aa0dbdb11b9d1f6bdb83e76c09d60642ef5a4eb29838 extends Twig_Template
{
...
";
        ...
        if (($this->getAttribute($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "aNavigator", array()), "save", array()), "show", array()) == "Y")) {
            // line 10
            echo "<button data-limesurvey-submit='{ \"saveall\":\"saveall\" }' accesskey=\"s\" class='";
...
";
    ...
    {
        return array (  62 => 11,  57 => 10,  55 => 9,  45 => 7,  43 => 6,);
    }
...
<button data-limesurvey-submit='{ \"saveall\":\"saveall\" }' accesskey=\"s\" class='{{ aSurveyInfo.class.savelinkslia }} btn btn-default'>
            {{ gT('Resume later') }}
        </button>
{% endif %}
", "./subviews/navigation/save_buttons.twig", "/var/www/limesurvey/themes/survey/vanilla/views/subviews/navigation/save_buttons.twig");
    }
}
